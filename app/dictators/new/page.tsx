...
// Tipo para definir la estructura de un dictador
type Dictator = {
  id: string;
  name: string;
  territory: string;
...
export default function DictatorsPage() {
  // Estado para almacenar la lista de dictadores
  const [dictators, setDictators] = useState<Dictator[]>([]);

  // Función para obtener los dictadores desde el backend
  ...
  // Función para eliminar un dictador con confirmación previa
  const deleteDictator = async (id: string) => {
    ...
    try {
      ...
      fetchDictators(); // Refresca la lista tras eliminar
    } catch (error) {
  ...
  // Renderizado de la tabla con la lista de dictadores y acciones
  return (
    <main className="min-h-screen bg-black text-white p-6">
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        {/* Botón para crear un nuevo dictador */}
            ...
            {dictators.map((d) => (
              ...
              >
                ...
                <td className="px-4 py-2 flex flex-wrap gap-2">
                  ...
                  {/* Botón para administrar contestants */}
